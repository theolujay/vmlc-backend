...
class CompetitionAdmin(admin.ModelAdmin):
    list_display = ("name", "edition", "status", "start_date", "end_date", "created_at")
...
class CandidateCompetitionAdmin(admin.ModelAdmin):
    list_display = ("candidate", "competition", "status", "current_stage", "joined_at")
...
class CandidateStageProgressAdmin(admin.ModelAdmin):
    list_display = ("candidate_competition", "stage", "status", "updated_at")
