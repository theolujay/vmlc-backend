...
#             competition=comp, type=Stage.Type.SCREENING, order=1
#         )
#         league = Stage.objects.create(competition=comp, type=Stage.Type.LEAGUE, order=2)
...
#             name="Past Comp", edition=0, status=Competition.Status.CONCLUDED
#         )
