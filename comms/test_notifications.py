...
class NotificationHTTPTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.n1 = Notification.objects.create(recipient=self.user, subject="N1", message="M1")
        self.n2 = Notification.objects.create(recipient=self.user, subject="N2", message="M2")
    ...
    def test_mark_as_read(self):
        url = reverse("comms:mark-notification-as-read", kwargs={"notification_id": self.n1.id})
    ...
    def test_mark_as_read_not_found(self):
        url = reverse("comms:mark-notification-as-read", kwargs={"notification_id": 9999})
        response = self.client.patch(url)
