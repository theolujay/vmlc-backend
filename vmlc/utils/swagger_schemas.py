...
login_request_body = openapi.Schema(
    ...
    properties={
        ...
        'password': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_PASSWORD, example='strongpassword123'),
    },
)
...
password_change_request_body = openapi.Schema(
    ...
    properties={
        'email': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_EMAIL, example='user@example.com'),
        'otp': openapi.Schema(type=openapi.TYPE_STRING, example='123456'),
        'new_password': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_PASSWORD, example='newstrongpassword123'),
        'confirm_password': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_PASSWORD, example='newstrongpassword123'),
    },
)
...
exam_detail_request_body = openapi.Schema(
    ...
    properties={
        ...
        'is_active': openapi.Schema(type=openapi.TYPE_BOOLEAN),
        'questions': openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_INTEGER)),
    }
)
...
submit_score_request_body = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        'candidate_id': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_UUID),
        'score': openapi.Schema(type=openapi.TYPE_NUMBER, format=openapi.FORMAT_DECIMAL),
    }
)
...
token_refresh_request_body = openapi.Schema(
    ...
    required=['refresh'],
    properties={
        'refresh': openapi.Schema(type=openapi.TYPE_STRING, description='The refresh token to get a new access token.'),
    },
)
        ...
        'results': openapi.Schema(
            ...
            items=openapi.Schema(
                ...
                properties={
                    ...
                    'mediums': openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_STRING)),
                    'target_roles': openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_STRING)),
                }
            )
        )
    }
...
broadcast_detail_response_schema = openapi.Schema(
    ...
    properties={
        ...
        'target_roles': openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_STRING)),
        'status': openapi.Schema(type=openapi.TYPE_STRING),
        'last_attempt': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_DATETIME),
