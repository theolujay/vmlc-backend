...
1. [Authentication](authentication.md) - Learn how to authenticate your requests
2. [Quick Start](quickstart.md) - Make your first API call
3. [API Reference](../api/index.md) - Explore all available endpoints
